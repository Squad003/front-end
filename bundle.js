...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n  <!-- Show Pages -->\n\n  <div>\n\n    <div>\n      <div class=\"content-"
	    ...
	    + " content page-name\">title: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
	    + " </div>\n    </div>\n    <div>\n      <div class=\"content-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + " content page-due\">body: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.content : stack1), depth0))
	    + "</div>\n    </div>\n    <div>\n      <button type=\"button\" class=\"delete-page-button btn btn-danger\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
	    + "\">Delete</button>\n    </div>\n    <div>\n      <button type=\"button\" class=\"edit-page-button btn btn-success\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
	    + "\">Edit</button>\n    </div>\n  </div>\n\n<!--\n  <form class=\"page-edit-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
	    + " page-edit hidden\"  data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
	    + "\">\n    <div class=\"row row-centered\">\n      <div class=\"col-xs-3 col-centered box\">\n        <div class=\"content text-center\">\n          <input type=\"text\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
	    + "\" name=\"page[title]\">\n          <textarea rows=\"4\" cols=\"30\" placeholder=\"put content here\" name=\"page[content]\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.content : stack1), depth0))
	    + "</textarea>\n        </div>\n      </div>\n        <div class=\"col-xs-3 col-centered box\">\n          <div class=\"content text-center\"><button type=\"submit\" class=\"edit-submit btn btn-success\">Update</button></div>\n        </div>\n      </div>\n    </form>\n-->\n\n  <!-- Edit Page Modal -->\n  <div class=\"modal fade page-edit-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
	    + " edit-page-modal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\">\n    <div class=\"modal-dialog\" role=\"document\">\n      <div class=\"modal-content\">\n        <div class=\"modal-header\">\n          <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>\n          <h4 class=\"modal-title\" id=\"editPageModalLabel\">Edit Page</h4>\n        </div>\n        <div class=\"modal-body\">\n          <form class=\"edit-page-form\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
	    + "\">\n            <div class=\"form-group\">\n              <label>Edit Page Title</label>\n              <input type=\"text\" maxlength=\"25\" class=\"form-control\" name=\"page[title]\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
	    + "\">\n            </div>\n            <div class=\"form-group\">\n              <label>Edit Page Content</label>\n              <textarea rows=\"4\" cols=\"30\" class=\"form-control\" name=\"page[content]\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.content : stack1), depth0))
	    + "</textarea>\n            </div>\n            <button type=\"submit\" class=\"btn btn-primary\" id=\"edit-page-submit\">Submit</button>\n            <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">Cancel</button>\n          </form>\n          <div class=\"page-failure\"></div>\n        </div>\n      </div>\n    </div>\n  </div>\n\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n  <!-- Show Pages -->\n  <div>\n    <div class>\n    <div >\n      <button type=\"button\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
	    + "\"class=\"btn btn-success show-page-button btn-group btn-group-justified\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n  <div class=\"container\">\n    <div class=\"row row-centered\">\n\n      <div class=\"col-centered box col-sm-6\">\n        <div class=\"content\">title: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
	    + " </div>\n        <div class=\"content\">body: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.content : stack1), depth0))
	    + "</div>\n      </div>\n      <div class=\"col-centered box col-sm-6\">\n\n      </div>\n    </div>\n      <div class=\"row row-centered\">\n      <div class=\"col-xs-2 col-centered box\">\n        <button type=\"button\" class=\"delete-post-button btn btn-danger\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
	    + "\">Delete</button>\n      </div>\n      <div class=\"col-xs-2 col-centered box\">\n        <button type=\"button\" class=\"edit-post-button btn btn-success\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
	    + "\">Edit</button>\n      </div>\n    </div>\n  </div>\n\n  <!--Edit blogpost Modal-->\n   <div class=\"modal fade blog-edit-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
	    + " edit-post-modal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\">\n     <div class=\"modal-dialog\" role=\"document\">\n       <div class=\"modal-content\">\n         <div class=\"modal-header\">\n           <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>\n           <h4 class=\"modal-title\" id=\"editPageModalLabel\">Edit Page</h4>\n         </div>\n         <div class=\"modal-body\">\n           <form class=\"blog-edit\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
	    ...
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.content : stack1), depth0))
	    + "</textarea>\n             </div>\n             <button type=\"submit\" class=\"btn btn-primary\" id=\"edit-post-submit\">Submit</button>\n             <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">Cancel</button>\n           </form>\n           <div class=\"post-failure\"></div>\n         </div>\n       </div>\n     </div>\n   </div>\n\n  <!--\n    <form class=\"blog-edit-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
	    + " blog-edit hidden\"  data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
	    + "\">\n      <div class=\"row row-centered\">\n        <div class=\"col-xs-3 col-centered box\">\n          <div class=\"content text-center\">\n            <input type=\"text\" placeholder=\"put title here\" name=\"blogpost[title]\">\n            <textarea rows=\"4\" cols=\"30\" placeholder=\"put content here\" name=\"blogpost[content]\"></textarea>\n          </div>\n        </div>\n          <div class=\"col-xs-3 col-centered box\">\n            <div class=\"content text-center\"><button type=\"submit\" class=\"edit-submit btn btn-success\">Update</button></div>\n          </div>\n        </div>\n      </form>\n    -->\n\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n  <!-- Show Pages -->\n  <div class=\"row row-centered\">\n    <div class=\"col-xs-4 col-centered box\">\n      <div class=\"content-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + " content page-name\">blog: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
	    + " </div>\n    </div>\n    <div class=\"col-xs-4 col-centered box\">\n      <div class=\"content-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + " content page-due\">content: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.content : stack1), depth0))
	    + "</div>\n    </div>\n  </div>\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onEditPost = function onEditPost(event) {
	  ...
	  api.editPost(id, data).then(function () {
	    ui.editPostSuccess();
	    return api.indexMyPosts();
	  }).then(ui.indexMyPostsSuccess).catch(ui.failure);
	};
	...
	var showUpdate = function showUpdate(e) {
	  var className = '.blog-edit-' + $(e.target).data('id');
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "52ed7b564f322a38defae78cd090b69b.jpg";
