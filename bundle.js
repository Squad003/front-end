...
/***/ function(module, exports, __webpack_require__) {
	...
	var blogEvents = __webpack_require__(38);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var papi = __webpack_require__(5);
	var pui = __webpack_require__(8);

	var bapi = __webpack_require__(30);
	var bui = __webpack_require__(31);
	...
	var onSignIn = function onSignIn(event) {
	  ...
	  api.signIn(data).then(function (response) {
	    ...
	    pui.indexMyPagesSuccess(response);
	    return bapi.indexMyPosts();
	  }).then(bui.indexMyPostsSuccess).catch(ui.failure);
	};
	...
	var onShowUsers = function onShowUsers(event) {
	  event.preventDefault();
	  api.showUsers().then(ui.showUsersSuccess).catch(ui.error);
	};

	var onSearchUsers = function onSearchUsers(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  ...
	  api.searchUsers(data).then(ui.searchUsersSuccess).catch(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var newPage = function newPage(data) {
	  return $.ajax({
	...
	var indexMyPages = function indexMyPages() {
	  return $.ajax({
	...
	var showOtherUsersPages = function showOtherUsersPages(id) {
	  return $.ajax({
	    url: config.host + '/pages/' + id,
	    method: 'GET'
	  });
	...
	var editPage = function editPage(id, data) {
	  return $.ajax({
	    url: config.host + '/pages/' + id,
	    method: 'PATCH',
	    data: data,
	...
	var deletePage = function deletePage(id) {
	  return $.ajax({
	    url: config.host + '/pages/' + id,
	    method: 'DELETE',
	    headers: {
	...
	module.exports = {
	  newPage: newPage,
	  indexMyPages: indexMyPages,
	  showPage: showPage,
	  deletePage: deletePage,
	  editPage: editPage,
	  showOtherUsersPages: showOtherUsersPages
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showPages = __webpack_require__(9);
	var showUsersPages = __webpack_require__(29);
	...
	var indexMyPagesSuccess = function indexMyPagesSuccess(data) {
	  // console.log('data is ', data);
	  $('.show-pages').html(showPages(data));
	  $('.show-pages').show();
	};

	var showOthersPageSuccess = function showOthersPageSuccess(data) {
	  // console.log('data is ', data);
	...
	module.exports = {
	  success: success,
	  indexMyPagesSuccess: indexMyPagesSuccess,
	  showOthersPageSuccess: showOthersPageSuccess,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n  <!-- Show Pages -->\n\n  <div class=\"show-pages-wrapper\">\n      <div id=page-"
	    ...
	    + "</p>\n        </div>\n      </div>\n      <div>\n        <button type=\"button\" class=\"edit-page-button\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
	    + "\">Edit</button>\n      </div>\n      <div>\n        <button type=\"button\" class=\"delete-page-button\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
	    + "\">Delete</button>\n      </div>\n    </div>\n\n\n\n  <form class=\"page-edit-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
	    + " page-edit hidden\"  data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
	    + "\">\n    <div class=\"form-group\">\n      <label>Edit Page Title</label>\n        <input type=\"text\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
	    + "\" name=\"page[title]\">\n    </div>\n    <div class=\"form-group\">\n      <label>Edit Page Body</label>\n        <textarea rows=\"4\" cols=\"30\" placeholder=\"put content here\" name=\"page[content]\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.content : stack1), depth0))
	    + "</textarea>\n    </div>\n    <button type=\"submit\" class=\"edit-submit btn btn-success\">Update</button>\n    <button type=\"button\" class=\"btn btn-default hide-page-update\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
	    + "\">Cancel</button>\n    </form>\n  </div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n<button type=\"button\" data-id=\""
	    ...
	    + "\" class=\"show-page-button show-other-blog-button\">Blog</button>\n\n"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var indexMyPosts = function indexMyPosts() {
	  return $.ajax({
	...
	var showOtherUsersPosts = function showOtherUsersPosts(id) {
	  return $.ajax({
	...
	var editPost = function editPost(id, data) {
	  return $.ajax({
	    url: config.host + '/blogposts/' + id,
	    method: 'PATCH',
	    data: data,
	...
	module.exports = {
	  ...
	  indexMyPosts: indexMyPosts,
	  showOtherUsersPosts: showOtherUsersPosts,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showMyPosts = __webpack_require__(32);
	var showUserPosts = __webpack_require__(33);
	...
	var indexPostsSuccess = function indexPostsSuccess() {};

	var indexMyPostsSuccess = function indexMyPostsSuccess(data) {
	  // console.log('posts are', data);
	  $('.show-all-my-posts').html(showMyPosts(data));
	};

	var showOtherUsersPostsSuccess = function showOtherUsersPostsSuccess(data) {
	  // console.log('posts are ', data);
	  $('.user-pages').show();
	  // $('.user-posts').show();
	...
	var searchPostSuccess = function searchPostSuccess(data) {
	  $('.user-posts').html(showUserPosts(data));
	  $('.user-posts').show();
	  $('.user-data').hide();
	...
	module.exports = {
	  failure: failure,
	  success: success,
	  indexPostsSuccess: indexPostsSuccess,
	  indexMyPostsSuccess: indexMyPostsSuccess,
	  showOtherUsersPostsSuccess: showOtherUsersPostsSuccess,
	  deletePostSuccess: deletePostSuccess,
	  editPostSuccess: editPostSuccess,
	  searchPostSuccess: searchPostSuccess
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n<div class=\"show-posts-wrapper\">\n  <div id=\"post-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
	    + "\">\n    <div>\n      <div>\n        <div class=\"content blogpost-title\">\n          <p>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
	    + "</p>\n         </div>\n        <div class=\"content blogpost-content\">\n          <p>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.content : stack1), depth0))
	    + "</p>\n        </div>\n      </div>\n    </div>\n      <div>\n        <button type=\"button\" class=\"edit-post-button\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
	    + "\">Edit</button>\n      </div>\n      <div>\n        <button type=\"button\" class=\"delete-post-button\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
	    + "\">Delete</button>\n      </div>\n    </div>\n  </div>\n\n  <form class=\"hidden blog-edit\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
	    + "\" id=\"edit-blog-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
	    + "\">\n    <div class=\"form-group\">\n      <label>Edit Post Title</label>\n      <input type=\"text\" maxlength=\"25\" class=\"form-control\" name=\"blogpost[title]\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
	    + "\">\n    </div>\n    <div class=\"form-group\">\n      <label>Edit Post Content</label>\n      <textarea rows=\"4\" cols=\"30\" class=\"form-control\" name=\"blogpost[content]\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.content : stack1), depth0))
	    + "</textarea>\n    </div>\n    <button type=\"submit\" class=\"btn btn-primary\" data-edit=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
	    + "\">Submit</button>\n    <button type=\"button\" class=\"btn btn-default cancel-button\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
	    + "\">Cancel</button>\n  </form>\n  <div class=\"post-failure\"></div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.blogposts : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
	},"useData":true,"useBlockParams":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n  <!-- Show Pages -->\n\n<div class=\"show-user-posts-wrapper\">\n  <div class=\"content-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + " content user-post-title\">\n    <p> "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
	    + " </p>\n  </div>\n  <div class=\"content-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + " content user-post-body\">\n    <p>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.content : stack1), depth0))
	    + "</p>\n  </div>\n</div>\n\n\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1, alias1=container.lambda, alias2=container.escapeExpression;
	  ...
	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.blogposts : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    ...
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.blogpost : depth0)) != null ? stack1.id : stack1), depth0))
	    + " content page-name\">\n      <p> "
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.blogpost : depth0)) != null ? stack1.title : stack1), depth0))
	    + " </p>\n      </div>\n  </div>\n  <div class=\"col-xs-4 col-centered box\">\n    <div class=\"content-"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.blogpost : depth0)) != null ? stack1.id : stack1), depth0))
	    + " content page-due\">\n      <p>"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.blogpost : depth0)) != null ? stack1.content : stack1), depth0))
	    + "</p>\n    </div>\n  </div>\n</div>\n-->\n";
	},"useData":true,"useBlockParams":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var searchUsers = function searchUsers(data) {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(7);
	var successError = __webpack_require__(36);
	// const showPages = require('../handlebars/show-pages.handlebars');
	var showUserList = __webpack_require__(37);
	...
	var showUsersSuccess = function showUsersSuccess(data) {
	...
	var searchUsersSuccess = function searchUsersSuccess(data) {
	  $('.user-list').html(showUserList(data));
	  $('.user-list').show();
	  $('.user-data').hide();
	  $('.search-user-fail').hide();
	...
	module.exports = {
	  ...
	  showUsersSuccess: showUsersSuccess,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n<div class=\"row row-centered\">\n\n  <div class=\"col-xs-4 col-centered box complete-user\">\n    <button type=\"button\" class=\"go-to-user-button btn btn-success\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
	    + "\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.user_name : stack1), depth0))
	    + "</button>\n  </div>\n\n</div>\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.users : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
	},"useData":true,"useBlockParams":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onNewPost = function onNewPost(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  api.newPost(data).then(function () {
	    ui.success();
	    return api.indexMyPosts();
	  }).then(ui.indexMyPostsSuccess).catch(ui.failure);
	};

	var onIndexPosts = function onIndexPosts(event) {
	  event.preventDefault();
	  api.indexPosts().then(ui.indexPostsSuccess).catch(ui.failure);
	};

	var onIndexMyPosts = function onIndexMyPosts(event) {
	  event.preventDefault();
	  api.indexMyPosts().then(ui.indexMyPostsSuccess).catch(ui.failure);
	};
	...
	var onEditPost = function onEditPost(event) {
	  ...
	  api.editPost(id, data).then(function (res) {
	...
	var showUpdate = function showUpdate(e) {
	  var className = '#edit-blog-' + $(e.target).data('id');
	  var post = '#post-' + $(e.target).data('id');
	...
	var onSearchPosts = function onSearchPosts(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  ...
	  api.searchPosts(data).then(ui.searchPostSuccess).catch(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onNewPage = function onNewPage(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  api.newPage(data).then(function () {
	    ui.success();
	    return api.indexMyPages();
	  }).then(ui.indexMyPagesSuccess).catch(ui.failure);
	};

	var onIndexMyPages = function onIndexMyPages(event) {
	  event.preventDefault();
	  api.indexMyPages().then(ui.indexMyPagesSuccess).catch(ui.failure);
	};

	var showUpdate = function showUpdate(e) {
	  var className = '.page-edit-' + $(e.target).data('id');
	  var page = "#page-" + $(e.target).data('id');
	  $(className).removeClass('hidden');
	  $(page).hide();
	};

	var hideUpdate = function hideUpdate(e) {
	  var className = '.page-edit-' + $(e.target).data('id');
	  var page = "#page-" + $(e.target).data('id');
	  $(className).addClass('hidden');
	  $(page).show();
	...
	var onEditPage = function onEditPage(event) {
	  ...
	  api.editPage(id, data).then(function (data) {
	...
	var onDeletePage = function onDeletePage(event) {
	  event.preventDefault();
	  var id = $(this).data('id');
	  api.deletePage(id).then(function () {
	    ui.deletePageSuccess();
	    return api.indexMyPages();
	  }).then(ui.indexMyPagesSuccess).catch(ui.failure);
	};

	var onShowOtherUsersData = function onShowOtherUsersData(event) {
	  event.preventDefault();
	  var id = $(this).data('id');
	  api.showOtherUsersPages(id).then(function (data) {
	    ui.showOthersPageSuccess(data);
	    return bapi.showOtherUsersPosts(id);
	  }).then(bui.showOtherUsersPostsSuccess).catch(ui.failure);
	};
	...
	var onPageClick = function onPageClick(event) {
	  ...
	  api.showPage(id).then(function (data) {
	    // console.log('data is ', data);
	...
	var showHideBlog = function showHideBlog() {
	  $('.user-posts').show();
	  $('.show-page-content').hide();
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "915d6e44fee38e89b6bdb85ecfdc5699.jpg";
