...
/***/ function(module, exports, __webpack_require__) {
	...
	var blogEvents = __webpack_require__(32);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onSignIn = function onSignIn(event) {
	  ...
	  }).then(pui.indexMyPagesSuccess).catch(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n  <!-- Show Pages -->\n  <div class=\"row row-centered\">\n    <div class=\"col-xs-4 col-centered box\">\n      <div class=\"content-"
	    ...
	    + "</div>\n    </div>\n    <div class=\"col-xs-4 col-centered box complete-page\">\n      <button type=\"button\" class=\"delete-page-button btn btn-success\" data-id=\""
...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(7);
	var successError = __webpack_require__(31);
	var showPages = __webpack_require__(9);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onNewPost = function onNewPost(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  api.newPost(data).then(ui.success).catch(ui.failure);
	};
	...
	var onIndexMyPosts = function onIndexMyPosts(event) {
	  event.preventDefault();
	  api.indexMyPosts().then(ui.onIndexMyPostsSuccess).catch(ui.failure);
	};
	...
	var onEditPost = function onEditPost(event) {
	  ...
	  var data = getFormFields(this);
	  api.editPost(id, data).then(ui.onEditPostSuccess).catch(ui.failure);
	};
	...
	var onDeletePost = function onDeletePost(event) {
	  event.preventDefault();
	  var id = $(this).data('id');
	  api.deletePost(id).then(ui.onDeletePostSuccess).catch(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showMyPosts = __webpack_require__(35);
	...
	var indexPostsSuccess = function indexPostsSuccess(data) {
	  console.log('data is', data);
	};

	var onIndexMyPostsSuccess = function onIndexMyPostsSuccess(data) {
	  console.log('data is', data);
	  $('.show-all-my-posts').html(showMyPosts(data));
	};

	var onEditPostSuccess = function onEditPostSuccess(data) {
	  console.log('data is', data);
	};
	...
	module.exports = {
	  ...
	  onIndexMyPostsSuccess: onIndexMyPostsSuccess,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n  <div class=\"post-container\">\n    <div class=\"row row-centered\">\n      <div class=\"col-xs-4 col-centered box\">\n        <div class=\"content-"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.chore : depth0)) != null ? stack1.id : stack1), depth0))
	    + " content chore-name\">title: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
	    + " </div>\n      </div>\n      <div class=\"col-xs-4 col-centered box\">\n        <div class=\"content-"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.chore : depth0)) != null ? stack1.id : stack1), depth0))
	    + " content chore-due\">body: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.content : stack1), depth0))
	    + "</div>\n      </div>\n      <div class=\"col-xs-4 col-centered box complete-chore\">\n        <button type=\"button\" class=\"delete-post-button btn btn-success\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onNewPage = function onNewPage(event) {
	  ...
	  var data = getFormFields(this);
	  console.log('data is ', data);
	  api.newPage(data).then(ui.success).catch(ui.failure);
	};
	...
	var onEditPage = function onEditPage(event) {
	  ...
	  var id = $(event.target).data('id');
	  var data = getFormFields(this);
	  api.editPage(id, data).then(ui.editPageSuccess).catch(ui.failure);
	};
